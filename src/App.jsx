...
export default function App() {
  ...
  return (
    <div className="bg-bg-base text-white font-mono antialiased selection:bg-racing-red/30 selection:text-white overflow-x-hidden relative">
      ...
      <a
        href="https://wa.me/919588499371"
        target="_blank"
        rel="noopener noreferrer"
        className="fixed bottom-6 right-6 z-[99] bg-[#25D366] text-white p-4 rounded-full shadow-[0_0_20px_rgba(37,211,102,0.4)] hover:scale-110 transition-transform duration-300 flex items-center justify-center group pointer-events-auto"
