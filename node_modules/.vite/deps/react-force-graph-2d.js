...
Dispatch.prototype = dispatch.prototype = {
  ...
  on: function(typename, callback) {
    var _2 = this._, T2 = parseTypenames2(typename + "", _2), t5, i2 = -1, n2 = T2.length;
    if (arguments.length < 2) {
      while (++i2 < n2) if ((t5 = (typename = T2[i2]).type) && (t5 = get(_2[t5], typename.name))) return t5;
      return;
    }
    if (callback != null && typeof callback !== "function") throw new Error("invalid callback: " + callback);
    while (++i2 < n2) {
      if (t5 = (typename = T2[i2]).type) _2[t5] = set(_2[t5], typename.name, callback);
...
function timer(callback, delay2, time2) {
  var t5 = new Timer();
  t5.restart(callback, delay2, time2);
  return t5;
}
function timerFlush() {
  now();
...
function selectAll_default3(select) {
  ...
  for (var groups2 = this._groups, m3 = groups2.length, subgroups = [], parents = [], j2 = 0; j2 < m3; ++j2) {
    for (var group2 = groups2[j2], n2 = group2.length, node, i2 = 0; i2 < n2; ++i2) {
      if (node = group2[i2]) {
        for (var children2 = select.call(node, node.__data__, i2, group2), child, inherit2 = get2(node, id2), k2 = 0, l2 = children2.length; k2 < l2; ++k2) {
...
function baseUnset(object, path) {
  ...
  while (++index8 < length) {
    ...
    if (key === "constructor" && index8 + 1 < length && typeof path[index8 + 1] === "string" && path[index8 + 1] === "prototype") {
...
function C2(n2) {
  if (n2.__P && n2.__d) {
    var u2 = n2.__v, t5 = u2.__e, i2 = [], r2 = [], o2 = w({}, u2);
    o2.__v = u2.__v + 1, l.vnode && l.vnode(o2), z(n2.__P, o2, u2, n2.__n, n2.__P.namespaceURI, 32 & u2.__u ? [t5] : null, i2, null == t5 ? S(u2) : t5, !!(32 & u2.__u), r2), o2.__v = u2.__v, o2.__.__k[o2.__i] = o2, V(i2, o2, r2), u2.__e = u2.__ = null, o2.__e != t5 && M(o2);
  }
}
function M(n2) {
...
function I() {
  try {
    for (var n2, l2 = 1; i.length; ) i.length > l2 && i.sort(e), n2 = i.shift(), l2 = i.length, C2(n2);
  } finally {
    i.length = I.__r = 0;
  }
}
function P(n2, l2, u2, t5, i2, r2, o2, e3, f2, c5, s2) {
  var a3, h2, y3, d2, w2, g2, _2, m3 = t5 && t5.__k || v, b = l2.length;
  for (f2 = A2(u2, l2, m3, f2, b), a3 = 0; a3 < b; a3++) null != (y3 = u2.__k[a3]) && (h2 = -1 != y3.__i && m3[y3.__i] || p, y3.__i = a3, g2 = z(n2, y3, h2, i2, r2, o2, e3, f2, c5, s2), d2 = y3.__e, y3.ref && h2.ref != y3.ref && (h2.ref && D2(h2.ref, null, y3), s2.push(y3.ref, y3.__c || d2, y3)), null == w2 && null != d2 && (w2 = d2), (_2 = !!(4 & y3.__u)) || h2.__k === y3.__k ? f2 = H(y3, f2, n2, _2) : "function" == typeof y3.type && void 0 !== g2 ? f2 = g2 : d2 && (f2 = d2.nextSibling), y3.__u &= -7);
  return u2.__e = w2, f2;
}
function A2(n2, l2, u2, t5, i2) {
  var r2, o2, e3, f2, c5, s2 = u2.length, a3 = s2, h2 = 0;
  for (n2.__k = new Array(i2), r2 = 0; r2 < i2; r2++) null != (o2 = l2[r2]) && "boolean" != typeof o2 && "function" != typeof o2 ? ("string" == typeof o2 || "number" == typeof o2 || "bigint" == typeof o2 || o2.constructor == String ? o2 = n2.__k[r2] = m(null, o2, null, null, null) : d(o2) ? o2 = n2.__k[r2] = m(k, { children: o2 }, null, null, null) : void 0 === o2.constructor && o2.__b > 0 ? o2 = n2.__k[r2] = m(o2.type, o2.props, o2.key, o2.ref ? o2.ref : null, o2.__v) : n2.__k[r2] = o2, f2 = r2 + h2, o2.__ = n2, o2.__b = n2.__b + 1, e3 = null, -1 != (c5 = o2.__i = T(o2, u2, f2, a3)) && (a3--, (e3 = u2[c5]) && (e3.__u |= 2)), null == e3 || null == e3.__v ? (-1 == c5 && (i2 > s2 ? h2-- : i2 < s2 && h2++), "function" != typeof o2.type && (o2.__u |= 4)) : c5 != f2 && (c5 == f2 - 1 ? h2-- : c5 == f2 + 1 ? h2++ : (c5 > f2 ? h2-- : h2++, o2.__u |= 4))) : n2.__k[r2] = null;
  if (a3) for (r2 = 0; r2 < s2; r2++) null != (e3 = u2[r2]) && 0 == (2 & e3.__u) && (e3.__e == t5 && (t5 = S(e3)), E2(e3, e3));
  return t5;
}
function H(n2, l2, u2, t5) {
  var i2, r2;
  if ("function" == typeof n2.type) {
    for (i2 = n2.__k, r2 = 0; i2 && r2 < i2.length; r2++) i2[r2] && (i2[r2].__ = n2, l2 = H(i2[r2], l2, u2, t5));
    return l2;
  }
...
function T(n2, l2, u2, t5) {
  var i2, r2, o2, e3 = n2.key, f2 = n2.type, c5 = l2[u2], s2 = null != c5 && 0 == (2 & c5.__u);
  if (null === c5 && null == e3 || s2 && e3 == c5.key && f2 == c5.type) return u2;
  if (t5 > (s2 ? 1 : 0)) {
...
function F(n2, l2, u2, t5, i2) {
  var r2, o2;
  n: if ("style" == l2) if ("string" == typeof u2) n2.style.cssText = u2;
  else {
    if ("string" == typeof t5 && (n2.style.cssText = t5 = ""), t5) for (l2 in t5) u2 && l2 in u2 || j(n2.style, l2, "");
    if (u2) for (l2 in u2) t5 && u2[l2] == t5[l2] || j(n2.style, l2, u2[l2]);
  }
...
function z(n2, u2, t5, i2, r2, o2, e3, f2, c5, s2) {
  var a3, h2, p2, y3, _2, m3, b, S2, C3, M2, $2, I2, A3, H2, L, T2 = u2.type;
  if (void 0 !== u2.constructor) return null;
  128 & t5.__u && (c5 = !!(32 & t5.__u), o2 = [f2 = u2.__e = t5.__e]), (a3 = l.__b) && a3(u2);
  n: if ("function" == typeof T2) try {
    if (S2 = u2.props, C3 = T2.prototype && T2.prototype.render, M2 = (a3 = T2.contextType) && i2[a3.__c], $2 = a3 ? M2 ? M2.props.value : a3.__ : i2, t5.__c ? b = (h2 = u2.__c = t5.__c).__ = h2.__E : (C3 ? u2.__c = h2 = new T2(S2, $2) : (u2.__c = h2 = new x(S2, $2), h2.constructor = T2, h2.render = G), M2 && M2.sub(h2), h2.state || (h2.state = {}), h2.__n = i2, p2 = h2.__d = true, h2.__h = [], h2._sb = []), C3 && null == h2.__s && (h2.__s = h2.state), C3 && null != T2.getDerivedStateFromProps && (h2.__s == h2.state && (h2.__s = w({}, h2.__s)), w(h2.__s, T2.getDerivedStateFromProps(S2, h2.__s))), y3 = h2.props, _2 = h2.state, h2.__v = u2, p2) C3 && null == T2.getDerivedStateFromProps && null != h2.componentWillMount && h2.componentWillMount(), C3 && null != h2.componentDidMount && h2.__h.push(h2.componentDidMount);
    else {
      if (C3 && null == T2.getDerivedStateFromProps && S2 !== y3 && null != h2.componentWillReceiveProps && h2.componentWillReceiveProps(S2, $2), u2.__v == t5.__v || !h2.__e && null != h2.shouldComponentUpdate && false === h2.shouldComponentUpdate(S2, h2.__s, $2)) {
        u2.__v != t5.__v && (h2.props = S2, h2.state = h2.__s, h2.__d = false), u2.__e = t5.__e, u2.__k = t5.__k, u2.__k.some(function(n3) {
          n3 && (n3.__ = u2);
        }), v.push.apply(h2.__h, h2._sb), h2._sb = [], h2.__h.length && e3.push(h2);
        break n;
      }
      null != h2.componentWillUpdate && h2.componentWillUpdate(S2, h2.__s, $2), C3 && null != h2.componentDidUpdate && h2.__h.push(function() {
        h2.componentDidUpdate(y3, _2, m3);
      });
    }
    if (h2.context = $2, h2.props = S2, h2.__P = n2, h2.__e = false, I2 = l.__r, A3 = 0, C3) h2.state = h2.__s, h2.__d = false, I2 && I2(u2), a3 = h2.render(h2.props, h2.state, h2.context), v.push.apply(h2.__h, h2._sb), h2._sb = [];
    else do {
      h2.__d = false, I2 && I2(u2), a3 = h2.render(h2.props, h2.state, h2.context), h2.state = h2.__s;
    } while (h2.__d && ++A3 < 25);
    h2.state = h2.__s, null != h2.getChildContext && (i2 = w(w({}, i2), h2.getChildContext())), C3 && !p2 && null != h2.getSnapshotBeforeUpdate && (m3 = h2.getSnapshotBeforeUpdate(y3, _2)), H2 = null != a3 && a3.type === k && null == a3.key ? q(a3.props.children) : a3, f2 = P(n2, d(H2) ? H2 : [H2], u2, t5, i2, r2, o2, e3, f2, c5, s2), h2.base = u2.__e, u2.__u &= -161, h2.__h.length && e3.push(h2), b && (h2.__E = h2.__ = null);
  } catch (n3) {
    ...
    else u2.__e = t5.__e, u2.__k = t5.__k, n3.then || N(u2);
    l.__e(n3, u2, t5);
  }
  else null == o2 && u2.__v == t5.__v ? (u2.__k = t5.__k, u2.__e = t5.__e) : f2 = u2.__e = B2(t5.__e, u2, t5, i2, r2, o2, e3, c5, s2);
...
function V(n2, u2, t5) {
  for (var i2 = 0; i2 < t5.length; i2++) D2(t5[i2], t5[++i2], t5[++i2]);
...
function B2(u2, t5, i2, r2, o2, e3, f2, c5, s2) {
  var a3, h2, v2, y3, w2, _2, m3, b = i2.props || p, k2 = t5.props, x3 = t5.type;
  if ("svg" == x3 ? o2 = "http://www.w3.org/2000/svg" : "math" == x3 ? o2 = "http://www.w3.org/1998/Math/MathML" : o2 || (o2 = "http://www.w3.org/1999/xhtml"), null != e3) {
    for (a3 = 0; a3 < e3.length; a3++) if ((w2 = e3[a3]) && "setAttribute" in w2 == !!x3 && (x3 ? w2.localName == x3 : 3 == w2.nodeType)) {
      u2 = w2, e3[a3] = null;
      break;
    }
  }
  ...
  if (null == x3) b === k2 || c5 && u2.data == k2 || (u2.data = k2);
    ...
    if (e3 = e3 && n.call(u2.childNodes), !c5 && null != e3) for (b = {}, a3 = 0; a3 < u2.attributes.length; a3++) b[(w2 = u2.attributes[a3]).name] = w2.value;
    for (a3 in b) w2 = b[a3], "dangerouslySetInnerHTML" == a3 ? v2 = w2 : "children" == a3 || a3 in k2 || "value" == a3 && "defaultValue" in k2 || "checked" == a3 && "defaultChecked" in k2 || F(u2, a3, null, w2, o2);
    for (a3 in k2) w2 = k2[a3], "children" == a3 ? y3 = w2 : "dangerouslySetInnerHTML" == a3 ? h2 = w2 : "value" == a3 ? _2 = w2 : "checked" == a3 ? m3 = w2 : c5 && "function" != typeof w2 || b[a3] === w2 || F(u2, a3, w2, b[a3], o2);
    if (h2) c5 || v2 && (h2.__html == v2.__html || h2.__html == u2.innerHTML) || (u2.innerHTML = h2.__html), t5.__k = [];
    else if (v2 && (u2.innerHTML = ""), P("template" == t5.type ? u2.content : u2, d(y3) ? y3 : [y3], t5, i2, r2, "foreignObject" == x3 ? "http://www.w3.org/1999/xhtml" : o2, e3, f2, e3 ? e3[0] : i2.__k && S(i2, 0), c5, s2), null != e3) for (a3 = e3.length; a3--; ) g(e3[a3]);
    c5 || (a3 = "value", "progress" == x3 && null == _2 ? u2.removeAttribute("value") : null != _2 && (_2 !== u2[a3] || "progress" == x3 && !_2 || "option" == x3 && _2 != b[a3]) && F(u2, a3, _2, b[a3], o2), a3 = "checked", null != m3 && m3 != u2[a3] && F(u2, a3, m3, b[a3], o2));
  }
  return u2;
}
...
function E2(n2, u2, t5) {
  var i2, r2;
  if (l.unmount && l.unmount(n2), (i2 = n2.ref) && (i2.current && i2.current != n2.__e || D2(i2, null, u2)), null != (i2 = n2.__c)) {
  ...
  if (i2 = n2.__k) for (r2 = 0; r2 < i2.length; r2++) i2[r2] && E2(i2[r2], u2, t5 || "function" != typeof n2.type);
...
function J(u2, t5, i2) {
  var r2, o2, e3, f2;
  t5 == document && (t5 = document.documentElement), l.__ && l.__(u2, t5), o2 = (r2 = "function" == typeof i2) ? null : i2 && i2.__k || t5.__k, e3 = [], f2 = [], z(t5, u2 = (!r2 && i2 || t5).__k = _(k, null, [u2]), o2 || p, p, t5.namespaceURI, !r2 && i2 ? [i2] : o2 ? null : t5.firstChild ? n.call(t5.childNodes) : null, e3, !r2 && i2 ? i2 : o2 ? o2.__e : t5.firstChild, r2, f2), V(e3, u2, f2);
}
function Q(l2, u2, t5) {
...
function add_default3(d2) {
  ...
  return add4(this.cover(x3, y3), x3, y3, d2);
}
function add4(tree, x3, y3, d2) {
  if (isNaN(x3) || isNaN(y3)) return tree;
  var parent2, node = tree._root, leaf = { data: d2 }, x0 = tree._x0, y0 = tree._y0, x1 = tree._x1, y1 = tree._y1, xm, ym, xp, yp, right, bottom, i2, j2;
  if (!node) return tree._root = leaf, tree;
  while (node.length) {
    if (right = x3 >= (xm = (x0 + x1) / 2)) x0 = xm;
    else x1 = xm;
...
function add_default4(d2) {
  const x3 = +this._x.call(null, d2), y3 = +this._y.call(null, d2), z3 = +this._z.call(null, d2);
  return add5(this.cover(x3, y3, z3), x3, y3, z3, d2);
}
function add5(tree, x3, y3, z3, d2) {
...
function addAll3(data) {
  ...
  for (let i2 = 0; i2 < n2; ++i2) {
    add5(this, xz[i2], yz[i2], zz[i2], data[i2]);
  }
  return this;
}
...
function find_default4(x3, y3, z3, radius) {
